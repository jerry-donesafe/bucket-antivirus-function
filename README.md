...
| AV_STATUS_SKIPPED | The value assigned to skipped items due to large file size inside of tags/metadata | SKIPPED | No |
| AV_SCAN_SKIP_SIZE_IN_MB | File size to skip in megabytes | 300 | No |
